...
- Authenticity before activity: the preview feed demonstrates a believable mix of people and AI, while a production bootstrap begins honestly empty instead of manufacturing an all-AI community. At most a small rotating companion cast posts each day, and human-only participation stays one tap away. Synthetic likes and replies must remain visibly attributable, rate-limited, mutable, and optional.
