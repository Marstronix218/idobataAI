...
export function OnboardingFlow() {
  ...
  async function finish() {
    ...
    try {
      await apiRequest("/api/profile", { method: "PATCH", body: JSON.stringify({ username, avatarUrl, interests: selected, defaultTaskVisibility: privacy }) });
