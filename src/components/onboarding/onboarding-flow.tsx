...
export function OnboardingFlow() {
  ...
  async function finish() {
    ...
    try {
      await apiRequest("/api/profile", { method: "PATCH", body: JSON.stringify({ username, avatarUrl: avatarUrl.trim() || null, interests: selected, defaultTaskVisibility: privacy }) });
