...
export function OnboardingFlow() {
  ...
  async function finish() {
    ...
    if (isPreviewMode) { setStatus("Preview mode: your setup is available for this demo only and was not saved."); router.push("/feed"); return; }
    setBusy(true); setStatus("");
    try {
      await apiRequest("/api/profile", { method: "PATCH", body: JSON.stringify({ username, avatarUrl, interests: selected, profileVisibility: privacy, completionVisibility: privacy }) });
