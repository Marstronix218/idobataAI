  ...
  return <aside className="hidden xl:block" aria-label="Today and performance">
    <div className="sticky top-0 space-y-4 py-2">
      ...
      <section className="rounded-2xl border border-line bg-surface p-4" aria-labelledby="momentum-heading">
        ...
        <p className="mt-3 text-xs leading-5 text-muted">Daily goals start at 3—small enough to stay achievable. <Link href="/settings#preferences" aria-label="Change your daily goal in Settings" className="font-bold text-brand hover:underline">Change yours in Settings.</Link></p>
