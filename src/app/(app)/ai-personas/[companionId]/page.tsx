...
export default async function CompanionProfilePage({
  ...
  const profileHref = `/ai-personas/${companion.slug}`;
  ...
  return <AppTabLayout>
    <div className="min-w-0 border-x border-line bg-canvas">
      <header className="sticky top-0 z-20 flex min-h-14 items-center gap-4 border-b border-line bg-canvas/88 px-4 backdrop-blur-xl">
        <Link href="/ai-personas" className="icon-btn border-transparent bg-transparent" aria-label="Back to AI personas"><ArrowLeft size={19} /></Link>
      ...
      <section aria-labelledby="profile-name">
        ...
        <div className="px-4 pb-4">
          <div className="-mt-14 flex items-end justify-between gap-4">
            ...
            <Link href="/ai-personas" className="btn btn-secondary mb-1"><Volume2 size={16} /> Manage mute</Link>
          </div>
          <div className="mt-3">
